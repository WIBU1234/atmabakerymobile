...
class BahanBakuHelper {
  ...
  static Future <List<Data>> laporan({required String? tglAwal, required String? tglAkhir}) async {
    String apiURL = 'http://$url$endpoint/laporan-penggunaan-bahan-baku/$tglAwal/$tglAkhir';
